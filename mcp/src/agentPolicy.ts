...
export function formatAgentPolicyMarkdown(): string {
...
export type AssessRequestResult = {
  should_ask_user: boolean;
  clarifying_questions: string[];
  recommended_tool: "none_yet" | "describe_table" | "search_schema" | "execute_query" | "run_analysis";
  tool_reason: string;
...
export function assessRequest(input: AssessRequestInput): AssessRequestResult {
  ...
  let recommended: AssessRequestResult["recommended_tool"] = "execute_query";
