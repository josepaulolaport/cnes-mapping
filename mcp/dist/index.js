...
import { listTables, describeTable, getRelationships, searchSchema, executeQuery, } from "./tools/queries.js";
import { runAnalysis, listAnalysisRuns, getAnalysisGuide, } from "./tools/analysisRunner.js";
import { assessRequest, buildServerInstructions, formatAgentPolicyMarkdown, } from "./agentPolicy.js";
const server = new Server({ name: "cnes-mcp-test", version: "1.0.0" }, {
    ...
    tools: [
        {
            ...
            description: "Full operating rules: when to ask clarifying questions, execute_query vs run_analysis, CNES filters. " +
                "Call this first on complex or ambiguous requests.",
            inputSchema: { type: "object", properties: {} },
        },
        {
            name: "assess_request",
            description: "Given the user's natural-language request, return clarifying questions to ask, recommended tool, " +
        ...
        {
            name: "execute_query",
            description: "Run a read-only SELECT against mcp_test (auto-LIMIT 500). ONLY for small lookups: samples, " +
        ...
        {
            name: "run_analysis",
            description: "Python analysis runner (pandas + read-only SQL). Use for aggregations, rankings, multi-step analysis, " +
        ...
        },
        {
            ...
            description: "Documentation for writing analysis code: helpers, rules, and examples for Excel vs written reports",
            inputSchema: { type: "object", properties: {} },
        },
    ],
}));
...
server.setRequestHandler(ReadResourceRequestSchema, async (request) => {
    ...
    if (uri === "schema://sample-queries") {
        const queries = manifest
            ? Object.fromEntries([...Object.entries(manifest.tables), ...Object.entries(manifest.views)]
